...
def set_args():
    ...
    parser.add_argument('--train_num', default=50000, type=int, help='用于训练的图像数量')
    # 训练相关参数
    ...
    parser.add_argument('--num_epochs', type=int, default=40, help='number of epochs to train for, default=10')
    parser.add_argument('--lr', type=float, default=1e-2, help='select the learning rate, default=1e-2')
    # 打印输出
